...
$checks += [pscustomobject]@{ Name = "AEDT 2023 R1"; Ok = ($null -ne $aedt); Detail = if ($null -ne $aedt) { $aedt.Executable } else { "ANSYSEM_ROOT231 or AEDT 2023.1 registry key was not found" } }
